    ...
    return (
      <Html lang="en">
        <Head>
          ...
          <meta
            name="dc:description"
            content="Crowdfunding platform. Kickstart your idea and get global support."
          />
          <meta name="dc.publisher" content="BlockStarter" />
          <meta name="dc.title" content="BlockStarter" />
